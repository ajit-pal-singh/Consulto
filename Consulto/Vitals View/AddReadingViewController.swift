...
class AddReadingViewController: UIViewController {
    ...
    @objc @IBAction func didTapHeartRate() { onHeartRateTap?() }
    @objc @IBAction func didTapBloodPressure() { onBloodPressureTap?() }
    @objc @IBAction func didTapBloodGlucose() { onBloodGlucoseTap?() }
    @objc @IBAction func didTapBodyWeight() { onBodyWeightTap?() }
}
