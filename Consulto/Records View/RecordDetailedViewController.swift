...
class RecordDetailedViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        facilityLabel.font = .systemFont(ofSize: facilityLabel.font.pointSize, weight: .regular).rounded
        ...
        summaryLabel.font = .systemFont(ofSize: summaryLabel.font.pointSize, weight: .regular).rounded
        summaryHeadingLabel.font = .systemFont(ofSize: summaryHeadingLabel.font.pointSize, weight: .bold).rounded
        overviewLabel.font = .systemFont(ofSize: overviewLabel.font.pointSize, weight: .bold).rounded
    }
    ...
    private func updateImageConstraints() {
        ...
        if let widthConstraint = imageViewWidthConstraint {
            ...
            print("Warning: imageViewWidthConstraint is disconnected. Please reconnect it in Storyboard.")
        }
        ...
        if let heightConstraint = imageViewHeightConstraint {
            ...
            print("Warning: imageViewHeightConstraint is disconnected. Please connect it to the image view height.")
        }
        ...
        if let containerHeight = imageContainerHeightConstraint {
            ...
            print("Warning: imageContainerHeightConstraint is disconnected. Please connect it to the container view height.")
        }
